        ...
        <>
            <div ref={ref} className='h-[150vh] sm:h-[250vh] relative'>
                <div className='flex flex-col h-full items-center justify-center'>
                    ...
                    <p className='text-sm sm:text-lg text-gray-500 w-3/4 sm:w-3/6 text-center mt-6'>Sophia adalah solusi lengkap pembelajaran online – kelola kelas, bagikan tugas, penilaian, dan materi serta jalin komunikasi yang efektif, semuanya dalam satu tempat.</p>
