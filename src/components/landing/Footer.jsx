                ...
                <div className='grid-motif w-full h-[50vh]'>
                    <div className='h-full' style={{
                        ...
                        <div className='container mx-auto max-w-[1200px] h-full px-4 py-6 flex items-end'>
                            <div className='w-full flex justify-between'>
                                <h1 className='text-8xl sm:text-9xl font-bold'>Terima Kasih</h1>
                            </div>
                        </div>
                    </div>
                    <div className='container mx-auto max-w-[1200px] px-4 py-6'>
                        <div className='flex flex-col sm:flex-row justify-between items-baseline gap-y-6'>
                            <p className='text-sm sm:text-lg w-3/4 sm:w-1/2 text-gray-500 py-4'>Terima kasih telah mempercayai kami sebagai solusi pembelajaran Anda. Kami berkomitmen untuk terus mendukung perjalanan belajar Anda dengan fitur-fitur terbaik!</p>
